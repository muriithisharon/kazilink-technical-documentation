...
export default function Home() {
  return (
    <div className="max-w-7.5xl mx-auto p-6 lg:p-10 space-y-16">
        ...
        <div className="relative rounded-2xl overflow-hidden shadow-lg border border-gray-200">
          ...
          <div className="absolute top-0 left-0 right-0 p-6 bg-gradient-to-b from-black/70 to-transparent">
            <a
              ...
              className="inline-flex items-center gap-3 text-white font-bold text-xl hover:underline transition"
            >
